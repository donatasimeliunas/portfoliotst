    ...
    <div className="max-w-4xl mx-auto flex flex-col gap-8 text-left">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="md:w-2/3">
          ...
          <p className="mb-4">
            Mano vardas Donatas Šimeliūnas. Iki šiol esu sukūręs keturis trumpametražius filmus, kuriuos galite{" "}
            <Link href="/short-films" className="text-blue-600 hover:underline">
              rasti
            </Link>{" "}
            šioje svetainėje. Vykdydamas šiuos projektus įgijau praktinės patirties beveik visuose filmavimo gamybos ir postprodukcijos etapuose. Tvirčiausiai jaučiuosi scenarijaus rašymo, režisūros, operatoriaus ir montažo vaidmenyse, būtent šiose vaidmenyse labiausiai norėčiau prisidėti prie jūsų projekto, bet esu atviras visiems pasiūlymams.
          </p>
          <p className="mb-4">
             Mano {" "}
            <Link
          ...
          <p className="mb-4">
            Šiuo metu gyvenu Prancūzijos pietuose, Landes regione, bet dažnai keliauju į Lietuvą.
          </p>
      ...
      <div className="mt-12">
        ...
        <div className="w-full">
          <Link href={`/short-films/${featuredFilm.id}`} className="block">
